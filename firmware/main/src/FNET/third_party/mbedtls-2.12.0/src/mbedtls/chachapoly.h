 ...
 */
MBEDTLSFLASHMEM void mbedtls_chachapoly_init( mbedtls_chachapoly_context *ctx );
 ...
 */
MBEDTLSFLASHMEM void mbedtls_chachapoly_free( mbedtls_chachapoly_context *ctx );
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_setkey( mbedtls_chachapoly_context *ctx,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_starts( mbedtls_chachapoly_context *ctx,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_update_aad( mbedtls_chachapoly_context *ctx,
 ...
 *                  finished.
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_update( mbedtls_chachapoly_context *ctx,
                               size_t len,
 ...
 *                  finished.
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_finish( mbedtls_chachapoly_context *ctx,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_encrypt_and_tag( mbedtls_chachapoly_context *ctx,
                                        size_t length,
                                        const unsigned char nonce[12],
                                        const unsigned char *aad,
                                        size_t aad_len,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_auth_decrypt( mbedtls_chachapoly_context *ctx,
                                     size_t length,
                                     const unsigned char nonce[12],
                                     const unsigned char *aad,
                                     size_t aad_len,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_chachapoly_self_test( int verbose );
