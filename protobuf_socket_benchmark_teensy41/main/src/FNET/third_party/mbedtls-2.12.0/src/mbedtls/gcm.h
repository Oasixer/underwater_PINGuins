 ...
 */
MBEDTLSFLASHMEM void mbedtls_gcm_init( mbedtls_gcm_context *ctx );
 ...
 */
MBEDTLSFLASHMEM int mbedtls_gcm_setkey( mbedtls_gcm_context *ctx,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_gcm_crypt_and_tag( mbedtls_gcm_context *ctx,
                       int mode,
                       size_t length,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_gcm_auth_decrypt( mbedtls_gcm_context *ctx,
                      size_t length,
                      const unsigned char *iv,
                      size_t iv_len,
                      const unsigned char *add,
 ...
 * \return          \c 0 on success.
 */
MBEDTLSFLASHMEM int mbedtls_gcm_starts( mbedtls_gcm_context *ctx,
                int mode,
                const unsigned char *iv,
                size_t iv_len,
                const unsigned char *add,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_gcm_update( mbedtls_gcm_context *ctx,
                size_t length,
                const unsigned char *input,
                unsigned char *output );
 ...
 * \return          #MBEDTLS_ERR_GCM_BAD_INPUT on failure.
 */
MBEDTLSFLASHMEM int mbedtls_gcm_finish( mbedtls_gcm_context *ctx,
                unsigned char *tag,
                size_t tag_len );
 ...
 */
MBEDTLSFLASHMEM void mbedtls_gcm_free( mbedtls_gcm_context *ctx );
 ...
 */
MBEDTLSFLASHMEM int mbedtls_gcm_self_test( int verbose );
